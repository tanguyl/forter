...
% If statements.
statement -> token_if token_bracket_open expression token_bracket_close:            [{'if', '$3'}].
statement -> token_if token_bracket_open expression token_bracket_close token_then: [{'if_then', '$3'}].
statement -> token_else token_if token_bracket_open expression token_bracket_close: [{'else_if', '$4'}].
statement -> token_else token_endl:                                                 [{'else_if', {boolean, 1}}].
statement -> token_end_if:                                                          [{'end_if'}].
